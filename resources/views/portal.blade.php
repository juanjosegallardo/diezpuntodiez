...
<html lang="es">
  <head>
    ...
    <title>Acceso a internet · CECyTEG</title>
    <style>
        ...
        <form action="%%AUTH_POST_URL%%" method="post" id="formulario" tabindex="-1" aria-labelledby="form-title">
          ...
          <p class="form-status" id="mensaje" role="status" aria-live="polite" aria-atomic="true"></p>
            <fieldset class="form-section">
                <legend><span class="section-number">01</span>Tu actividad</legend>
            ...
            <fieldset class="form-section">
                <legend><span class="section-number">02</span>Datos de acceso</legend>
                <div class="field-grid">
                <div class="fel">
                    <label for="ft_usuario">
                    Usuario:
                    </label>
                    <input id="ft_usuario" autocomplete="username" type="text" autocorrect="off" autocapitalize="off">
                    <a class="field-hint" target="_blank" rel="noopener noreferrer" href="http://10.10.10.10:8000/busqueda">Buscar mi usuario (abre otra pestaña)</a>
                </div>
                <div class="fel">
                    <label for="ft_password">
                    Contraseña:
                    </label>
                    <div class="password-field"><input id="ft_password" autocomplete="current-password" type="password" autocorrect="off" autocapitalize="off"><button class="password-toggle" id="passwordToggle" type="button" aria-controls="ft_password" aria-pressed="false" aria-label="Mostrar contraseña" hidden>Mostrar</button></div>
                </div>
                </div>
            </fieldset>
          <div class="fer">
...
var actividades = [];
    document.querySelector("form").addEventListener("submit", function (event) {
        ...
        document.getElementById("mensaje").textContent = "Autenticando....";
    ...
    function cargarActividades()
    {
      ...
      .then(data => {
        ...
        for(const item of data)
        {
          ...
          opcion.textContent = item.nombre + " " + (item.grupo ?? "");
