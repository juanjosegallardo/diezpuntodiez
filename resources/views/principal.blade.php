...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .welcome.is-paused *,
        .welcome.is-paused *::before,
        .welcome.is-paused *::after,
        .welcome.is-away *,
        .welcome.is-away *::before,
        .welcome.is-away *::after {
        ...
        @keyframes hero-perimeter {
            from {
                --hero-perimeter-angle: 0deg;
            }

            to {
                --hero-perimeter-angle: 360deg;
            }
        }
        ...
        .creator-signature::before {
            ...
            right: 15%;
            height: 1px;
            background: linear-gradient(90deg, transparent, #91e3ee60, #c6baff60, transparent);
        }
        ...
        .signature-logo img {
            ...
            max-width: 100%;
            height: auto;
            filter: brightness(0) invert(1) drop-shadow(0 0 10px #c6baff20);
        }

        .signature-person figcaption {
            display: flex;
            flex-direction: column;
        ...
        .signature-person--backend .signature-role {
            color: #d2c9ff;
        }
        ...
        @media (prefers-reduced-motion: no-preference) {
            .signature-photo {
                animation: portrait-rgb-flow 8s ease-in-out infinite;
            ...
            .signature-person:hover .signature-photo {
                transform: translateY(-2px);
                box-shadow: 0 0 0 1px #ffffff30, 0 10px 26px #00000040;
            }

            .signature-person:hover .signature-photo::before {
                opacity: .55;
            }
        }

        @keyframes portrait-rgb-flow {
        ...
        .welcome.is-arriving .welcome__path:nth-child(1) {
            animation-delay: 260ms;
        }

        .welcome.is-arriving .welcome__path:nth-child(2) {
            animation-delay: 320ms;
        }

        .welcome.is-arriving .welcome__path:nth-child(3) {
        ...
        <header class="topbar" id="topbar">
            <div class="topbar__inner container">
                ...
                <nav class="nav" id="mainNav" aria-label="Navegación principal">
                    ...
                    <a href="#servicios" class="nav__link"><svg class="nav__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                            <rect x="3" y="3" width="7" height="7" rx="1.5" />
                            <rect x="14" y="3" width="7" height="7" rx="1.5" />
                            <rect x="3" y="14" width="7" height="7" rx="1.5" />
                            <rect x="14" y="14" width="7" height="7" rx="1.5" />
                        </svg><span>Servicios</span></a>
                    <a href="#avisos" class="nav__link"><svg class="nav__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                            <path d="M18 8a6 6 0 0 0-12 0c0 7-3 7-3 9h18c0-2-3-2-3-9M10 21h4" />
                        </svg><span>Próximas</span></a>
                    <a href="#horarios" class="nav__link"><svg class="nav__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                            <rect x="3" y="5" width="18" height="16" rx="2" />
                            <path d="M16 3v4M8 3v4M3 11h18M8 15h2m4 0h2" />
                        </svg><span>Horarios</span></a>
                    <a href="{{ url('/test') }}" class="nav__link"><svg class="nav__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                ...
                <div class="topbar__actions">
                    <button class="icon-btn theme-toggle tooltip" id="themeSwitch" type="button" aria-label="Modo oscuro" aria-pressed="false" data-tooltip="Cambiar a modo oscuro">
                        <svg class="theme-toggle__sun" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                            <circle cx="12" cy="12" r="4" />
                            <path d="M12 2v2m0 16v2M2 12h2m16 0h2M5 5l1.5 1.5m11 11L19 19M5 19l1.5-1.5m11-11L19 5" />
                        </svg>
                        <svg class="theme-toggle__moon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                    ...
                    <a class="icon-btn tooltip topbar__notice" href="#avisos" aria-label="Ver próximas actividades" data-tooltip="Agenda del dia"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                            <path d="M18 8a6 6 0 0 0-12 0c0 7-3 7-3 9h18c0-2-3-2-3-9M10 21h4" />
                        </svg></a>
                ...
                <div class="hero__inner container">
                    <div class="hero__copy">
                        ...
                        <div class="hero__resources" role="group" aria-label="Acceso a la red del plantel">
                            <a class="resource-link resource-link--app" href="http://10.20.0.1:1000/login?" aria-describedby="packet-tracer-note">
                                <span class="resource-link__icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                        ...
                        <div class="hero__actions">
                            <a href="#examenes" class="hero__secondary-link hero__secondary-link--exam">Ver exámenes <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                                    <path d="M5 12h14m-6-6 6 6-6 6" />
                                </svg></a>
                            <a href="#servicios" class="hero__secondary-link">Ver servicios <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                                    <path d="M5 12h14m-6-6 6 6-6 6" />
                                </svg></a>
                        ...
                        <details class="packet-help" id="packetTracerHelp">
                            ...
                            <div class="packet-help__content">
                                ...
                                <a class="packet-help__download" href="{{ asset('downloads/configurar-packet-tracer.ps1') }}" download="configurar-packet-tracer.ps1"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                                        <path d="M12 3v12m-5-5 5 5 5-5M4 16v5h16v-5" />
                                    </svg>Descargar configurador para Windows</a>
                    ...
                    <figure class="hero__visual">
                        <div class="hero__photo">
                            ...
                            <span class="hero__badge"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                                    <path d="M20 10c0 5-8 12-8 12S4 15 4 10a8 8 0 0 1 16 0Z" />
                                    <circle cx="12" cy="10" r="3" />
                                </svg> Pénjamo, Guanajuato</span>
                        </div>
            ...
            <section class="quick-access container" id="servicios" tabindex="-1" aria-labelledby="quick-title">
                ...
                <div class="services__frequent">
                    ...
                    <a class="service-card service-card--lg service-card--classroom" data-semestre="1" href="https://miaula1.cecyteg.edu.mx" target="_blank" rel="noopener noreferrer">
                        ...
                        <span class="service-card__arrow" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                                <path d="M7 7h10v10M7 17 17 7" />
                            </svg></span><span class="sr-only">Abre en otra pestaña</span>
                    </a>
            ...
            <section class="content" aria-label="Directorio de servicios y agenda del dia">
                <div class="content__inner container">
                        ...
                        <section class="services__group">
                            ...
                            <div class="services__grid">
                                <a class="service-card" href="http://10.10.10.10:8000/me?url=superate" target="_blank" rel="noopener">
                                    <span class="service-card__icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                                            <path d="M12 2L14.4 8.5L21.5 9.2L16.2 13.9L17.8 21L12 17.3L6.2 21L7.8 13.9L2.5 9.2L9.6 8.5L12 2Z" />
                                        </svg></span>
                                    <span class="service-card__body">
                                ...
                                <a class="service-card" href="http://10.10.10.10/lanzador/index.php?planb" target="_blank" rel="noopener">
                                    <span class="service-card__icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                                            <path d="M4 12C4 7.58 7.58 4 12 4C14.5 4 16.73 5.15 18.2 6.94" />
                                            <path d="M18 3V7H14" />
                                            <path d="M20 12C20 16.42 16.42 20 12 20C9.5 20 7.27 18.85 5.8 17.06" />
                                            <path d="M6 21V17H10" />
                                        </svg></span>
                                    <span class="service-card__body">
                                ...
                                <a class="service-card" href="https://vr.vex.com/" target="_blank" rel="noopener">
                                    <span class="service-card__icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                                            <path d="M4 8C4 6.9 4.9 6 6 6H18C19.1 6 20 6.9 20 8V15C20 16.1 19.1 17 18 17H15.5L14 19.5C13.6 20.17 12.4 20.17 12 19.5L10.5 17H6C4.9 17 4 16.1 4 15V8Z" />
                            ...
                            <div class="services__grid">
                                ...
                                <a class="service-card" href="https://app.cecyteg.edu.mx/CampusCECyTEG" target="_blank" rel="noopener">
                                    <span class="service-card__icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                                            ...
                                            <path d="M5 16C5 14.5 6.5 13.5 8 13.5C9.5 13.5 11 14.5 11 16" />
                                            <path d="M14 10H18" />
                                            <path d="M14 13H18" />
                                        </svg></span>
                                    <span class="service-card__body">
                            ...
                            <div class="services__grid">
                                ...
                                <a class="service-card" href="https://encuestas.sh.guanajuato.gob.mx/#/enc/..." target="_blank" rel="noopener">
                                    <span class="service-card__icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                                            <path d="M8 12H16" />
                                            <path d="M8 16H13" />
                                            <path d="M17 3L21 7L11 17H7V13L17 3Z" />
                                        </svg></span>
                                    <span class="service-card__body">
                    ...
                    <aside class="sidebar" id="avisos" tabindex="-1">
                        ...
                        <div class="help-card"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                            ...
                            <a href="mailto:juangallardo@cecyteg.edu.mx">Contactar al Centro de Cómputo <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                                    <path d="M5 12h14m-6-6 6 6-6 6" />
                                </svg></a>
                        </div>
                    </aside>
            ...
            <section class="schedules-section container" id="horarios" tabindex="-1" aria-labelledby="schedules-title">
                ...
                <div class="schedule-browser">
                    ...
                    <div class="schedule-search" role="search" aria-label="Buscar horarios">
                        ...
                        <div class="schedule-search__field">
                            ...
                            <button class="schedule-search__clear" id="scheduleSearchClear" type="button" aria-label="Limpiar búsqueda" hidden><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" aria-hidden="true" focusable="false">
                ...
                <template id="scheduleCardTemplate">
                    <article class="schedule-card" data-pdf="">
                        ...
                        <p class="schedule-card__status"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                                <circle cx="12" cy="12" r="9" />
                                <path d="M12 7v5l3 2" />
                            </svg><span>Horario por publicar</span></p>
                        <div class="schedule-card__documents" hidden>
                            <div class="schedule-card__actions">
                                <a class="btn btn--primary" data-pdf-open target="_blank" rel="noopener noreferrer">Abrir PDF <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                                        <path d="M7 7h10v10M7 17 17 7" />
                                    </svg></a>
                                <a class="btn btn--ghost" data-pdf-download download>Descargar <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                                        <path d="M12 3v12m-4-4 4 4 4-4M4 17v4h16v-4" />
                                    </svg></a>
                            </div>
                            <details class="schedule-card__preview">
                                <summary>Vista previa <span class="sr-only" data-schedule-context></span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                                        <path d="m6 9 6 6 6-6" />
                                    </svg></summary>
            ...
            <div class="site-footer__inner container">
                ...
                <div class="site-footer__social">
                    <a href="#" aria-label="Facebook" class="social-btn">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
                            <path d="M15 8H17V5H15C13.34 5 12 6.34 12 8V10H10V13H12V19H15V13H17L18 10H15V8Z" />
                        </svg>
                    </a>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const scheduleCatalog = {
                grupos: [{
                        grupo: '2901',
                        pdf: @json(asset('horarios_grupos/2901.pdf'))
                    },
                    {
                        grupo: '2902',
                        pdf: @json(asset('horarios_grupos/2902.pdf'))
                    },
                    {
                        grupo: '2903',
                        pdf: @json(asset('horarios_grupos/2903.pdf'))
                    },
                    {
                        grupo: '2904',
                        pdf: @json(asset('horarios_grupos/2904.pdf'))
                    },
                    {
                        grupo: '2905',
                        pdf: @json(asset('horarios_grupos/2905.pdf'))
                    },
                    {
                        grupo: '2906',
                        pdf: @json(asset('horarios_grupos/2906.pdf'))
                    },
                    {
                        grupo: '3001',
                        pdf: @json(asset('horarios_grupos/3001.pdf'))
                    },
                    {
                        grupo: '3002',
                        pdf: @json(asset('horarios_grupos/3002.pdf'))
                    },
                    {
                        grupo: '3003',
                        pdf: @json(asset('horarios_grupos/3003.pdf'))
                    },
                    {
                        grupo: '3004',
                        pdf: @json(asset('horarios_grupos/3004.pdf'))
                    },
                    {
                        grupo: '3005',
                        pdf: @json(asset('horarios_grupos/3005.pdf'))
                    },
                    {
                        grupo: '3006',
                        pdf: @json(asset('horarios_grupos/3006.pdf'))
                    },
                    {
                        grupo: '3101',
                        pdf: @json(asset('horarios_grupos/3101.pdf'))
                    },
                    {
                        grupo: '3102',
                        pdf: @json(asset('horarios_grupos/3102.pdf'))
                    },
                    {
                        grupo: '3103',
                        pdf: @json(asset('horarios_grupos/3103.pdf'))
                    },
                    {
                        grupo: '3104',
                        pdf: @json(asset('horarios_grupos/3104.pdf'))
                    },
                    {
                        grupo: '3105',
                        pdf: @json(asset('horarios_grupos/3105.pdf'))
                    },
                    {
                        grupo: '3106',
                        pdf: @json(asset('horarios_grupos/3106.pdf'))
                    },
                ],
                docentes: [{
                        nombre: 'Angélica Gutiérrez Morales',
                        pdf: @json(asset('horarios_docentes/ANGELICA.pdf'))
                    },
                    {
                        nombre: 'Blanca Rosa Troncoso Domínguez',
                        pdf: @json(asset('horarios_docentes/BLANCA.pdf'))
                    }, // 02
                    {
                        nombre: 'Cristina Guerrero Rodríguez',
                        pdf: @json(asset('horarios_docentes/CRISTINA.pdf'))
                    }, // 03
                    {
                        nombre: 'David Zaragoza Torres',
                        pdf: @json(asset('horarios_docentes/DAVID.pdf'))
                    }, // 04
                    {
                        nombre: 'Héctor Mejía Martínez',
                        pdf: @json(asset('horarios_docentes/HECTOR.pdf'))
                    }, // 05
                    {
                        nombre: 'Hortensia Espitia Rodríguez',
                        pdf: @json(asset('horarios_docentes/HORTENSIA.pdf'))
                    }, // 06
                    {
                        nombre: 'Jaime Hernández Calderón',
                        pdf: @json(asset('horarios_docentes/JAIME.pdf'))
                    }, // 07
                    {
                        nombre: 'José Francisco González Alvarado',
                        pdf: @json(asset('horarios_docentes/JOSE.pdf'))
                    }, // 08
                    {
                        nombre: 'José Luis Luevanos Barragán',
                        pdf: @json(asset('horarios_docentes/JOSE_LUIS.pdf'))
                    }, // 09
                    {
                        nombre: 'Julia Elena Nuñes Soto',
                        pdf: @json(asset('horarios_docentes/JULIA.pdf'))
                    }, // 10
                    {
                        nombre: 'Octavio Ramírez Medel',
                        pdf: @json(asset('horarios_docentes/OCTAVIO.pdf'))
                    }, // 11
                    {
                        nombre: 'Reynaldo Negrete Soto',
                        pdf: @json(asset('horarios_docentes/REYNALDO.pdf'))
                    }, // 12
                    {
                        nombre: 'Roberto Baltazar Vázquez',
                        pdf: @json(asset('horarios_docentes/ROBERTO.pdf'))
                    }, // 13
                    {
                        nombre: 'Salvador Cabrera Vázquez',
                        pdf: @json(asset('horarios_docentes/SALVADOR.pdf'))
                    }, // 14
                    {
                        nombre: 'Victor Manuel Zapien Ceno',
                        pdf: @json(asset('horarios_docentes/VICTOR.pdf'))
                    }, // 15
                    {
                        nombre: 'Norberto Zavala García',
                        pdf: @json(asset('horarios_docentes/NORBERTO.pdf'))
                    }, // 16
                    {
                        nombre: 'Jonhy Walther Salinas Montejano',
                        pdf: @json(asset('horarios_docentes/JHONY.pdf'))
                    }, // 17
                    {
                        nombre: 'Xochitl Yesenia Rangel Segundo',
                        pdf: @json(asset('horarios_docentes/XOCHI.pdf'))
                    } // 18
                ]
            };
            ...
            function prepareScheduleBrowser() {
                ...
                const entries = [
                    ...scheduleCatalog.grupos.map(item => ({
                        ...item,
                        type: 'grupos',
                        title: 'Grupo ' + item.grupo,
                        context: 'del grupo ' + item.grupo
                    })),
                    ...scheduleCatalog.docentes.filter(item => item.nombre.trim()).sort((a, b) => a.nombre.localeCompare(b.nombre, 'es')).map(item => ({
                        ...item,
                        type: 'docentes',
                        title: item.nombre.trim(),
                        context: 'de ' + item.nombre.trim()
                    }))
                ];
            ...
            function prepareScheduleDocuments() {
                document.querySelectorAll('.schedule-card[data-pdf]').forEach(card => {
                    ...
                    let pdfUrl;
                    try {
                        pdfUrl = new URL(source, document.baseURI);
                    } catch {
                        return;
                    }
            ...
            window.addEventListener('wheel', resumeScrollTracking, {
                passive: true
            });
            window.addEventListener('touchmove', resumeScrollTracking, {
                passive: true
            });
            document.addEventListener('keydown', event => {
